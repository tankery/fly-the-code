...
最近又不务正业了。起因是从原来的博客网站复制的文章样式和排版无法原样的粘贴到微信公众号，想去改博客的样式，但因为原来的博客网站使用的模板虽然很漂亮，功能也强大，但代码真是写的一坨，完全没有修改的欲望。所以，干脆重写一个咯。

<!-- more -->

说起来，其实公众号排版问题也不多，其实主要就改了两个问题：

1. 标题、正文、代码等字体大小信息丢失。粘贴以后，标题反而变得更小，正文字体更大。
